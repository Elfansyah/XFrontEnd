  ...
  return (
    <div>
      <div className="bg-black lg:rounded-xl md:w-max w-screen  px-2 pt-2 py-8 ">
        ...
        <h1 className="text-3xl font-bold my-5 mx-10">Create your account</h1>
        <Formik
                  ...
                  <div className="flex flex-col gap-5">
                    <div>
                      <Field
                        ...
                        name="username"
                        placeholder="Name"
                        className=" md:min-w-[500px] mx-10  bg-black rounded-md pl-2 pr-10 py-4 border-2 border-gray-400"
                      />
                      <ErrorMessage
                        name="username"
                        component={"div"}
                    ...
                    <div>
                      <Field
                        ...
                        name="email"
                        placeholder="Email"
                        className=" bg-black md:min-w-[500px] mx-10 rounded-md pl-2 pr-10 py-4 border-2 border-gray-400"
                      />
                      <ErrorMessage
                        name="email"
                        component={"div"}
                    ...
                    <button
                      type="submit"
                      className="mt-10 bg-white text-black md:min-w-[500px] mx-10 py-4 rounded-full font-semibold hover:bg-gray-100"
                    >
                      Sign Up
                    </button>
                  </div>
