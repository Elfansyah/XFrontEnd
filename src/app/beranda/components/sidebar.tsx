...
export default function SideBar() {
    return (
        <div className="bg-black h-screen pt-10 pl-16 flex flex-col justify">
            <div>
            ...
            <div className="text-white pl-5 pt-10 pb-8 flex flex-col">
                <Link href="/" className="font-semibold pb-5 hover:text-primary">Home</Link>
                <Link href="/" className="font-semibold hover:text-primary" >About</Link>
            </div>
            <div className="pl-1">
